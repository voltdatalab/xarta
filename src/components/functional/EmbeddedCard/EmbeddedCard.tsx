        ...
        <CardFooter className="bg-[#E7E7E7] text-sm px-6 py-[17px] xarta-footer">
            <div className="w-full flex flex-col card-minimum:flex-row">
                <div className="flex flex-col grow">
                    ...
                    <p className="mt-2"><span className="font-semibold">{t('CREATED_BY_TEXT')}:</span> {/*post.primary_author.name*/} {settings.title} {" "} {post.featured ? <span>- <a className="text-[#4b31dd] underline" href={`${config.PUBLIC_ROOT_URL}/xarta/view-card/${post.id}`} target="_blank">{t('REPRODUCTION_ALLOWED_TEXT')}
